...
def spiketimes_path_load(arg1):
    ...
    for ntrial in range(1, trials+1):
        ...
        for nrun in range(1, nruns+1):
            ...
            pathd = '../make_inputs_linear_track/runs_produced_by_python_ec_rand_stops/run_'+str(nrun)
...
#            print len(path[:,0])
            ...
            for npyr in range(Npyramidals):
                ...
                for case in my_list:
                    ...
                    fileload = cond+'/'+case+'/Trial_'+str(ntrial)+'/Run_'+str(nrun)+'/spiketimes_pvsoma_.pkl'
