...
#    if metric=='information_all' or metric=='information_plc':
#        plt.ylim(0,2.0)
#        plt.yticks([0.0, 0.5, 1.0, 1.5, 2.0])
#    if metric=='stabilityIndex_all' or metric=='stabilityIndex_plc':
#        plt.ylim(0,1.0)    
#        plt.yticks([0.0, 0.25, 0.50, 0.75, 1.00])
    
    
    plt.savefig(path_figs+'/'+learning+'_'+metric+'_barplot.pdf',format='pdf',dpi=300)
#    plt.savefig(path_figs+'/'+metric+'_barplot.png',format='png',dpi=300)
#    plt.show()
    plt.cla()
    plt.clf()
    plt.close()
...
#    plt.savefig(path_figs+'/'+metric+'_boxplot.png',format='png',dpi=300)    
#    plt.show()
    plt.cla()
    plt.clf()
    plt.close()
